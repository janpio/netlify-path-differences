...
exports.handler = async (event, context) => {
  ...
  fs.readdir(process.env.LAMBDA_TASK_ROOT + "/src/functions/with-node_modules", function(err, items) {
    console.log("# content of process.env.LAMBDA_TASK_ROOT/src/functions/with-node_modules")
    console.log(items);
  })
 

  var imagepath = path.resolve(process.env.LAMBDA_TASK_ROOT, 'src/functions/with-node_modules', 'netlify.png')
